...
public class NMEA2OSG
{
   ...
   #region Events
    ...
    public bool ParseNMEA(string Nlat, string Nlon, double height)
    {
     ...
     deciLat = Convert.ToDouble(Nlat.Substring(0, Nlat.IndexOf("бу")));
     deciLon = Convert.ToDouble(Nlon.Substring(0, Nlon.IndexOf("бу")));
     
     //remove that bit from the string now we've used it and the ?symbol
     Nlat = Nlat.Substring(Nlat.IndexOf("бу") + 1);
     Nlon = Nlon.Substring(Nlon.IndexOf("бу") + 1);
